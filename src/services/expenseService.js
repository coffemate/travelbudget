...
async function addExpense(tripId, payload, userId) {
  ...
  if (!created_by || typeof created_by !== 'string') throw badRequest('created_by is required');
  if (paid_by && typeof paid_by !== 'string') throw badRequest('paid_by must be a string');
